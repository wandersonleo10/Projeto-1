# DataFrames e OperaÃ§Ãµes com DataFrame 
...
pesq = cbind(pesquisa, olhos) #ligação entre dois objetos pela coluna
pesq


# Informações sobre o dataframe
str(pesq) # resumo sobre os tipos de dados
dim(pesq) #numero de dimensões 5x5
length(pesq)
...
# Dataframes Nomeados
names(pesq) <- c("País", "Nome", "Altura", "CÃ³digo", "Olhos")
pesq
